...
- map listings data on `Search.jsx`
...
- create components `ListingItem.jsx`

- ` <p className='text-sm text-gray-600 line-clamp-2'>{listing.description}</p>`

- `line-clamp-2` to limit text content to a specified number of lines, adding an ellipsis (`...`) if the text overflows beyond that limit. 

- it need install the `line-clamp` Plugin
...
### 40. Add show more listing functionality

- create variable showMore

- `  const [showMore, setShowMore] = useState(false);`

- add element button Show more
...
- create functionality `onShowMoreClick()`
...
add the content top swiper and listings result for offer, sale and rent 
...
const Home = () => {
  ...
  const [rentListinggs, setRentListings] = useState([]);
  SwiperCore.use([Navigation]);
  ...
  useEffect(() => {
    ...
    const fetchSaleListings = async () => {
      try {
        const res = await axios.get('/api/listing/get?type=sell&limit=4');
  ...
  return (
    <div>
      ...
      <div className='max-w-6xl mx-auto p-3 flex flex-col gap-8 my-10'>
          ...
          saleListings && saleListings.length > 0 && (
            <div className=''>
              <div className='my-3'>
                ...
                <Link className='text-blue-800 text-sm hover:underline' to={'/search?type=sell'}>
                  Show more sale...
                </Link>
              </div>
              <div className='flex flex-wrap gap-4'>
        ...
        {
          rentListinggs && rentListinggs.length > 0 && (
            <div className=''>
              <div className='my-3'>
...
const About = () => {
  return (
    <div className=' max-w-6xl mx-auto py-20 px-4 mb-14'>
      <h1 className='text-3xl font-bold mb-8 text-slate-700'>About Sahand Estate</h1>
      <p className="text-slate-800 mb-14">At Sahand Estate, we are committed to providing exceptional real estate services to our valued clients. With years of experience in the real estate market, we specialize in residential, commercial, and investment properties, offering personalized solutions that align with your needs. Our team of dedicated professionals works tirelessly to ensure that your property journey is smooth, transparent, and efficient. Whether you're looking to buy, sell, rent, or invest, we pride ourselves on delivering superior results with the utmost integrity.</p>
      <p className="text-slate-800 mb-14" mb-14>Our extensive portfolio includes a wide range of properties in prime locations, with each listing carefully selected to meet the diverse preferences and investment goals of our clients. From luxurious homes in serene neighborhoods to thriving commercial spaces, Sahand Estate brings you opportunities that maximize value and provide long-term growth potential. Our expert team offers in-depth market insights, helping you make informed decisions while navigating the ever-changing real estate landscape. We understand that each client is unique, and we take the time to understand your specific requirements, guiding you every step of the way through the buying, selling, or leasing process.</p>
      <p className="text-slate-800 mb-14">At Sahand Estate, customer satisfaction is our top priority. Our mission is not just to meet expectations but to exceed them. We believe in creating lasting relationships built on trust and reliability. By providing timely updates, transparent communication, and comprehensive support, we ensure that your real estate experience is as seamless as possible. Whether you're a first-time homebuyer, a seasoned investor, or a business looking for the perfect commercial property, Sahand Estate is here to make your real estate dreams a reality.</p>
    </div>
  )
}
